...
def main(mytimer: func.TimerRequest) -> None:
    ...
    logging.info('Starting RSS file creation at %s', utc_timestamp)

    urls = [
    "https://b.hatena.ne.jp/q/%E6%8A%80%E8%A1%93?date_range=5y&users=100&target=tag&sort=recent&mode=rss",
    "https://b.hatena.ne.jp/q/%E7%A0%94%E7%A9%B6?date_range=5y&users=100&target=tag&sort=recent&mode=rss",
...
logging.info('Finished RSS file creation at %s', datetime.datetime.utcnow().replace(
    tzinfo=datetime.timezone.utc).isoformat())
